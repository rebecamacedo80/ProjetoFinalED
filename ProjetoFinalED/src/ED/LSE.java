...
public class LSE {
	...
	public int tamanho() {
        ...
        public int busca(int pos){
            No aux = cabeca;
	    int cont = 1;
            //alterei para poder usar na chamada de inserir em LSEFrame. 
            //lembrar de implementar essas consultas no frame quando for efetuar a busca
	    //if (vazia()) {
	...
	public boolean removeNaLista(int pos){
